...
public class VerifyMenuLayout {
	
	
	@Test
	public void verifyMenulayout() throws InterruptedException{
		...
		driver.findElement(Paths.NewrepoButton);
		driver.findElement(Paths.NewGistButton);
		driver.findElement(Paths.NeworgButton);
		driver.findElement(Paths.NewProjectButton);
		driver.findElement(Paths.ImportRepoButton);
		driver.quit();
